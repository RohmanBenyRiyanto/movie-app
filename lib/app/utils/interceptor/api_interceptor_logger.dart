...
class ApiInterceptorLogging implements Interceptor {
  ...
  void _logHeaders({required Map<String, dynamic> headers, Styles? style}) {
...
class Colorize {
  ...
  Colorize apply(Styles style) => Colorize("${style.toString()}$_text\x1B[0m");
...
class Styles {
  static const Styles RED = Styles._(30);
  static const Styles GREEN = Styles._(32);
  static const Styles YELLOW = Styles._(33);
  static const Styles LIGHT_GRAY = Styles._(37);

  final int _value;

  const Styles._(this._value);
