...
# Show message before starting the cleaning process
printColorMessage "=-------------------------------------------------=" "$PURPLE"
printColorMessage "=-------> START CLEANING FLUTTER PROJECTS <-------=" "$PURPLE"
printColorMessage "=-------------------------------------------------=" "$PURPLE"
echo
...
for FILE in $FILES; do
    ...
    printColorMessage "Cleaning project for: $FILE" "$CYAN"
    ...
    printColorMessage "-> Start Running flutter clean..." "$YELLOW"
    flutter clean || { printColorMessage "Error: Failed to clean project." "$RED"; exit 1; }
    ...
    printColorMessage "Project cleaned successfully for: $FILE" "$GREEN"
    echo
done

# Print a new line after all files are processed
printColorMessage "=--------------------------------------------------=" "$PURPLE"
printColorMessage "=-------> FINISH CLEANING FLUTTER PROJECTS <-------=" "$PURPLE"
printColorMessage "=--------------------------------------------------=" "$PURPLE"
echo
